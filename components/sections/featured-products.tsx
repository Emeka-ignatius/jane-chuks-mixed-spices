    ...
    <section className="py-20">
      <div className="container mx-auto px-4">
        <div className="text-center space-y-4 mb-16">
          ...
          <h2 className="text-3xl md:text-4xl font-bold gradient-text text-balance">Our Most Popular Spice Blends</h2>

          <p className="section-text text-muted-foreground max-w-2xl mx-auto text-pretty">
            Discover why thousands of customers trust JaneChucks Mixed Spices for their daily nutrition and wellness
            needs.
          </p>
        </div>
