...
const features = [
  ...
  },
  {
    ...
    description: "Our products are certified by NAFDAC, ensuring the highest standards of quality and safety.",
  ...
  },
  {
    icon: Truck,
    title: "Fast Delivery",
    description: "Quick and reliable delivery across Nigeria, ensuring your spices reach you fresh and on time.",
    color: "from-purple-500 to-purple-600",
  },
  {
    icon: Heart,
    title: "Health Focused",
    description: "Each blend is formulated with specific health benefits in mind, supporting your wellness journey.",
    color: "from-red-500 to-red-600",
  },
  {
    icon: Users,
    title: "Trusted by Thousands",
    description: "Join thousands of satisfied customers who have made JaneChucks their trusted spice partner.",
    ...
    <section className="py-20 bg-muted/30">
      <div className="container mx-auto px-4">
        <div className="text-center space-y-4 mb-16">
          ...
          <h2 className="text-3xl md:text-4xl font-bold gradient-text text-balance">The JaneChucks Difference</h2>

          <p className="section-text text-muted-foreground max-w-2xl mx-auto text-pretty">
            We're committed to providing you with the highest quality spice blends that not only enhance your meals but
            also support your health and wellness goals.
          </p>
        </div>
