      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-4xl mx-auto text-center space-y-8">
          <div className="space-y-4">
            ...
            <h2 className="text-3xl md:text-5xl font-bold text-balance">Ready to Transform Your Health?</h2>

            <p className="text-lg md:text-xl text-primary-foreground/90 max-w-2xl mx-auto text-pretty">
              Join thousands of satisfied customers who have made JaneChucks Mixed Spices part of their daily wellness
              routine. Start your journey to better health today.
            </p>
          </div>
          ...
          <div className="pt-8 border-t border-white/20">
            <p className="text-sm text-primary-foreground/70 mb-4">Trusted by over 5,000+ customers across Nigeria</p>
